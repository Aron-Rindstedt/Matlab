function [L2norm,v,mov] = schr2D(boundType,testType,NL)
...
% stepType = 0;  %0=RK4, 1=2nd order stepping
    ...
    if boundType==0
        ...
        bigD = -i*[bigDL big0LR; big0RL [bigDD big0DU; big0UD bigDU]];
    end
    ...
    function S = Neum(t)
        ...
        S = 0*[S0+S2L-S3L; -S1D+S2D; -S1U-S3U];
    end        
